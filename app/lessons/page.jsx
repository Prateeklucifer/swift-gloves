        ...
        <div className="md:px-4">
            <div className="container m-auto px-4 md:px-0">
                <div className="flex flex-col gap-3 items-center md:px-10 lg:px-32 xl:px-64 2xl:px-72">
                    ...
                    <div className="para text-white mt-3 md:text-center md:px-20 xl:px-44 2xl:px-56">With our computer science course IO Academy gives you the knowledge and confidence you need to excel in software engineering, and more.</div>
