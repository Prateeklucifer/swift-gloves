        ...
        <div className="md:px-4">
            ...
            <div className="container m-auto xl:flex xl:mt-6">
                <div className="left flex flex-col gap-3 px-4 md:pl-0 md:pr-5 lg:pr-8 xl:w-1/2 xl:justify-center md:items-center  ">
                    ...
                    <div className="para text-white mt-3  md:text-center">The IO Academy is an online learning platform that provides interactive courses and projects in Computer Science to high schoolers and adults of all backgrounds.</div>
