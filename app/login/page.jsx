        ...
        <div className="right flex flex-col gap-6 lg:w-[50%] justify-center px-16 py-20">
          ...
          <div className="name">
            ...
            <input
              ...
              name=""
              id="name"
              className="bg-gray-800 w-full px-2 py-1 outline-none outline-1 ring-1 rounded-sm ring-[#00FFFF]/60 focus:ring-[#00FFFF]"
              value={name}
              onChange={getName}
            />
          </div>
          ...
          <button
            className="text-white px-4 py-2 rounded-md bg-[#00FFFF]/60 hover:bg-[#00FFFF]/50 w-full font-semibold"
            onClick={sendRequest}
          >
            Login
          </button>
